...
public struct RegistryValue(string keyName, string? valueName)
{
    ...
    {
        return Reg.GetValue(KeyName, ValueName, defaultValue);
    }
    ...
    {
        return Reg.GetBinaryValue(KeyName, ValueName, defaultValue);
    }
    ...
    {
        Reg.SetValue(KeyName, ValueName, value);
    }
    ...
    {
        Reg.SetBinaryValue(KeyName, ValueName, value);
    }

    public readonly void SetValue(object value, RegistryValueKind valueKind)
    {
        Reg.SetValue(KeyName, ValueName, value, valueKind);
    }

    public readonly void DeleteValue()
    {
        Reg.DeleteValue(KeyName, ValueName!);
    }
    ...
    public bool HasKey()
    {
        using var key = Reg.OpenKey(KeyName);
        return key != null;
    }
